...
protocol KeyProtocolTemporary {
    ...
    init(key: String, value: CGFloat?, color: FLColor)
        init(key: String, xColors: [UIColor])
            init(key: String, yThresholds: [CGFloat : UIColor], data: [PlotableData])
                func textWithValue(formatter: FLFormatter) -> NSMutableAttributedString
}

public struct FLKey: KeyProtocolTemporary {
...
//@available(*, deprecated, renamed: "FLKey")
public struct Key: KeyProtocolTemporary {
