...
public struct FLLineConfig {
    ...
    public init(width: CGFloat = 4, capStyle: CGLineCap = .round, backgroundFill: FLColor = FLColor.Gradient.lightBlue, showCircles: Bool = false, circleColor: UIColor = .white) {
        self.width = width
